    ...
    <nav className="shadow-md fixed top-0 left-0 w-full z-50 bg-gradient-to-r from-blue-100 to-purple-200">
      <div className="max-w-screen-xl mx-auto flex justify-between items-center py-4 px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* Simple Cart Icon with Count Badge */}
          <div className="relative">
            <Link to="/cart" className="p-2 text-gray-600 hover:text-blue-500 transition">
        ...
        <div className="md:hidden bg-white shadow-lg py-4">
          <div className="px-6">
            ...
            <ul className="space-y-4 text-center text-gray-700 font-medium">
              <li><Link to="/" className="block py-2 hover:text-blue-500" onClick={() => setMenuOpen(false)}>Home</Link></li>
              <li><Link to="/collection" className="block py-2 hover:text-blue-500" onClick={() => setMenuOpen(false)}>Collection</Link></li>
              <li><Link to="/about" className="block py-2 hover:text-blue-500" onClick={() => setMenuOpen(false)}>About</Link></li>
              <li><Link to="/contact" className="block py-2 hover:text-blue-500" onClick={() => setMenuOpen(false)}>Contact</Link></li>
            </ul>
          </div>
        </div>
      )}
